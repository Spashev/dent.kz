    ...
    <section class="content">
        ...
        <div class="card-body">
            ...
            <div class="col-12 col-sm-6 col-md-3">
                ...
                <div class="col-12">
                <img src="{{asset('storage/'.$product->images()->first()->image_path)}}" class="product-image" alt="Product Image">
                </div>
                <div class="col-12 product-image-thumbs">
                    @foreach($product->images as $image)
                        <div class="product-image-thumb"><img src="{{ asset('storage/'.$image->image_path) }}" alt="Product Image"></div>
                    @endforeach()
                </div>
            </div>
            <div class="col-12 col-sm-6 col-md-9">
                ...
                <h4 class="mt-0">
                    <small>Ex Tax: {{$product->currency === "USD" ? "$" : $product->currency}}{{$product->price}} </small>
                </h4>
                </div>
